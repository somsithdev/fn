...
setTimeout(()=>{motor1.stop();console.log("rooftop is closed . . .")},2800)
...
setTimeout(()=>{motor1.stop();console.log("rooftop is opened . . .")},2800)
res.json({message: 'success! closed the rooftop'})
});
...
setTimeout(()=>{motor1.stop(); console.log("rooftop closed")},4000);
    }
});
...
setTimeout(()=>{motor.stop();console.log("Gate was opened")},3000)
...
setTimeout(()=>{motor.stop();console.log("Gate was closed")},3000)
